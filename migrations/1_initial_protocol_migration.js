var Migrations = artifacts.require("./contracts/governance/Migrations.sol");
var SenateAlpha = artifacts.require("./contracts/governance/SenateAlpha.sol");
var Timelock = artifacts.require("./contracts/governance/Timelock.sol");
var RubiconMarket = artifacts.require("./contracts/RubiconMarket.sol");
var RBCN = artifacts.require("./contracts/governance/RBCN.sol");
var Aqueduct = artifacts.require("./contracts/governance/Aqueduct.sol");
  ...
  deployer.deploy(Migrations).then(function() {
    ...
    return deployer.deploy(RBCN, Aqueduct.address, admin).then(function() {
      return deployer.deploy(Timelock, Migrations.address, 0).then(function(){   // Takes admin and initial delay that must exceed the minimum delay... ZERO FOR TESTING NOT PRODUCTION READY
        ...
        return deployer.deploy(SenateAlpha, Timelock.address, RBCN.address, admin, {gasPrice: 0}).then(function(){ //gaurdian of senate is admin
